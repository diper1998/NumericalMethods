...
/*
  ...
  */
    ...
    void SolveSystemSeidelBorder(double** u, double **f, double eps, int count, int N, int M, double h, double k, double* resEpsCount, double xBorder, double yBorder)
    {
...
void SolveSystemIterationBorder(double** u, double **f, double eps, int count, int N, int M, double h, double k, double t, double* resEpsCount, double xBorder, double yBorder)
{
